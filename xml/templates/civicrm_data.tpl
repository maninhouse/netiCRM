...
-- Activity Types for case activities
   ...
   (@option_group_id_IMProvider, 'Yahoo', 1, 'Yahoo', NULL, 0, NULL, 1, NULL, 0, 0, 0, NULL, NULL),
   (@option_group_id_IMProvider, 'MSN',   2, 'Msn',   NULL, 0, NULL, 2, NULL, 0, 0, 0, NULL, NULL),
   (@option_group_id_IMProvider, 'AIM',   3, 'Aim',   NULL, 0, NULL, 3, NULL, 0, 0, 0, NULL, NULL),
   (@option_group_id_IMProvider, 'GTalk', 4, 'Gtalk', NULL, 0, NULL, 4, NULL, 0, 0, 0, NULL, NULL),
   (@option_group_id_IMProvider, 'Jabber',5, 'Jabber',NULL, 0, NULL, 5, NULL, 0, 0, 0, NULL, NULL),
  ...
  (@option_group_id_cs, '{ts escape="sql"}Suspended{/ts}'  , 7, 'Suspended'  , NULL, 0, NULL, 7, NULL, 0, 1, 1, NULL, NULL),
...
-- they are used for display only in the prefernces field settings
  ...
  (@option_group_id_asOpt, '{ts escape="sql"}CiviMail{/ts}'                ,  19, 'CiviMail', NULL, 0, NULL, 21, NULL, 0, 0, 1, NULL, NULL),
  ...
  (@option_group_id_csearch , '{ts escape="sql"}Household Name and State{/ts}'               , 1, 'CRM_Contact_Form_Search_Custom_Sample'      , NULL, 0, NULL, 1, '', 0, 0, 1, NULL, NULL),
  (@option_group_id_csearch , '{ts escape="sql"}Contribution Aggregate{/ts}', 2, 'CRM_Contact_Form_Search_Custom_ContributionAggregate', NULL, 0, NULL, 2, '', 0, 0, 1, NULL, NULL),
  (@option_group_id_csearch , '{ts escape="sql"}Basic Search{/ts}'                , 3, 'CRM_Contact_Form_Search_Custom_Basic'       , NULL, 0, NULL, 3, '', 0, 0, 1, NULL, NULL),
  (@option_group_id_csearch , '{ts escape="sql"}Include / Exclude Contacts in a Group / Tag{/ts}'                , 4, 'CRM_Contact_Form_Search_Custom_Group'       , NULL, 0, NULL, 4, '', 0, 0, 1, NULL, NULL),
  (@option_group_id_csearch , '{ts escape="sql"}Postal Mailing{/ts}'        , 5, 'CRM_Contact_Form_Search_Custom_PostalMailing', NULL, 0, NULL, 5, '', 0, 0, 1, NULL, NULL),
  (@option_group_id_csearch , '{ts escape="sql"}Proximity Search{/ts}'            , 6, 'CRM_Contact_Form_Search_Custom_Proximity', NULL, 0, NULL, 6, '', 0, 0, 1, NULL, NULL),
  (@option_group_id_csearch , '{ts escape="sql"}Event Aggregate{/ts}'       , 7, 'CRM_Contact_Form_Search_Custom_EventAggregate', NULL, 0, NULL, 7, '', 0, 0, 1, NULL, NULL),
  (@option_group_id_csearch , '{ts escape="sql"}Activity Search{/ts}'       , 8, 'CRM_Contact_Form_Search_Custom_ActivitySearch', NULL, 0, NULL, 8, '', 0, 0, 1, NULL, NULL),
  (@option_group_id_csearch , '{ts escape="sql"}Price Set Details for Event Participants{/ts}'             , 9, 'CRM_Contact_Form_Search_Custom_PriceSet', NULL, 0, NULL, 9, '', 0, 0, 1, NULL, NULL),
...
-- phone types.
  (@option_group_id_pht, '{ts escape="sql"}Phone{/ts}' ,        1, 'Phone'      , NULL, 0, NULL, 2, NULL, 0, 0, 1, NULL, NULL),
  (@option_group_id_pht, '{ts escape="sql"}Mobile{/ts}',        2, 'Mobile'     , NULL, 0, NULL, 1, NULL, 0, 0, 1, NULL, NULL),
...
VALUES
  ( 'activityDate'    ,  30, 10, '',    '',   'Date for activities including contributions: receive, receipt, cancel. membership: join, start, renew. case: start, end.'         ),
  ( 'activityDateTime',  30, 10, '',    1,   'Date and time for activity: scheduled. participant: registered.'                                                                  ),
  ...
  ( 'custom'          ,  30, 20, '',    '',   'Uses date range passed in by form field. Can pass in a posix date part parameter. Start and end offsets defined here are ignored.'),
  ( 'mailing'         ,   0,  1, '',    '',   'Date and time. Used for scheduling mailings.'                                                                                      ),
  ( 'searchDate'        ,  30, 20, '',    '',   'Used in search forms.'                                                                                                            );
...
VALUES 
 ...
 ('ALLPAY', '{ts escape="sql"}AllPay Credit Card{/ts}', NULL, 1, 0, '{ts escape="sql"}Merchant ID{/ts}', 'HashKey', 'HashIV', '', 'Payment_ALLPAY', 'https://payment.ecpay.com.tw/Cashier/AioCheckOut', 'https://payment.ecpay.com.tw/Cashier/QueryTradeInfo', 'https://payment.ecpay.com.tw/Cashier/QueryCreditCardPeriodInfo', NULL, 'https://payment-stage.ecpay.com.tw/Cashier/AioCheckOut', 'https://payment-stage.ecpay.com.tw/Cashier/QueryTradeInfo', 'https://payment-stage.ecpay.com.tw/Cashier/QueryCreditCardPeriodInfo', NULL, 4, 1),
...
INSERT INTO civicrm_mailing_bounce_pattern 
    ...
    (@bounceTypeID, 'name service error');
...
INSERT INTO civicrm_mailing_bounce_pattern 
    ...
    (@bounceTypeID, 'service unavailable'),
    (@bounceTypeID, 'domain is not allowed'),
    (@bounceTypeID, '550.+domain.+facebook.+no longer available');
...
INSERT INTO civicrm_mailing_bounce_pattern 
    ...
    (@bounceTypeID, '550 user.+disabled'),
    (@bounceTypeID, 'tried to reach is disabled'),
    (@bounceTypeID, 'mailbox is disabled');
...
INSERT INTO civicrm_mailing_bounce_pattern 
    ...
    (@bounceTypeID, '550.+address rejected'),
    (@bounceTypeID, '550 user.+unknown'),
    (@bounceTypeID, 'no valid recipient'),
    (@bounceTypeID, 'tried to reach does not exist');
